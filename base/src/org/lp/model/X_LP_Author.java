...
/** Generated Model for LP_Author
 *  @author Adempiere (generated) 
 *  @version Costumizacion por alberto XD - $Id$ */
public class X_LP_Author extends PO implements I_LP_Author, I_Persistent 
{
    ...
    public X_LP_Author (Properties ctx, int LP_Author_ID, String trxName)
    {
      super (ctx, LP_Author_ID, trxName);
      /** if (LP_Author_ID == 0)
        {
			setLP_Author_ID (0);
			setName (null);
    ...
    /** Load Constructor */
    public X_LP_Author (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_LP_Author[")
